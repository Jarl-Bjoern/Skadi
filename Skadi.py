...
if __name__ == '__main__':
    ...
    required.add_argument('-tErr', '--target-error', type=str, required=True, help=Colors.GREEN+'This parameter specifies the error code which you get after a failure.'+Colors.RESET+'\n\n'+Colors.BLUE+'-------------------------------------------------------------------------------------'+Colors.RESET)
